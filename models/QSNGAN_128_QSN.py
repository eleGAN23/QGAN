...
class QSNGAN_D128_QSN(nn.Module):
    def __init__(self, spectral_normed=False, channel=4):
        super(QSNGAN_D128_QSN, self).__init__()
...
class QSNGAN_G128_QSN(nn.Module):
    def __init__(self, z_size=128, channel=4, batch_normed=False):
        super(QSNGAN_G128_QSN, self).__init__()
