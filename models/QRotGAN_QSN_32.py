...
from utils.Qops_with_QSN import conv2d, Residual_G, Residual_D, First_Residual_D, SNLinear
from utils.QBN_Vecchi2 import QuaternionBatchNorm2d as QBatchNorm


class QRotGAN_QSN_D32(nn.Module):
    def __init__(self, ssup, channel=4, spectral_normed=False):
        super(QRotGAN_QSN_D32, self).__init__()
...
class QRotGAN_QSN_G32(nn.Module):
    def __init__(self, z_size=128, channel=4, output_size = 32,
                 batch_normed=False):
        super(QRotGAN_QSN_G32, self).__init__()
        s = 4
        self.s = s
        self.z_size = z_size
